...
```{r}
library(readxl)
trash_data = read_excel("./HealthyHarborWaterWheelTotals2017-9-26.xlsx", sheet =  "Mr. Trash Wheel", 
  range = "A2:N258") %>%
  janitor::clean_names() %>%
...
Precipitation data
```{r}
precip_data16 = read_excel("./HealthyHarborWaterWheelTotals2017-9-26.xlsx", 
    sheet = "2016 Precipitation", 
    range = "A2:B14") %>%
    janitor::clean_names()

precip_data17 = read_excel("./HealthyHarborWaterWheelTotals2017-9-26.xlsx", 
